...
def seed_data():
    ...
    trip1 = Trip(destination='Giza', user_id=1, start_date=datetime.now(), end_date=datetime.now() + timedelta(days=7), description="A week exploring the wonders of Egypt!")
    trip2 = Trip(destination='New York', user_id=2, start_date=datetime.now(), end_date=datetime.now() + timedelta(days=5), description="A quick trip to the Big Apple!")
